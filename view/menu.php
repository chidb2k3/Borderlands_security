...
<body>
	<div>
		<header >
			...
			<div ><h1>BỘ CHỈ HUY BỘ ĐỘI BIÊN PHÒNG TỈNH QUẢNG BÌNH
			</h1></div>
	...
	<div  style="margin-top: 5px; max-width: 95%;">
		<ul class="nav justify-content-center" style="background-color:#CCFFFF;">
			<li class="nav-item"><a class="nav-link" href="../index.php"><b>TRANG CHỦ</b> </a></li>
			<li class="nav-item">
				<a class="nav-link active" aria-current="page" href="qlCanBo.php?cv=dsCanBo"><b>CÁN BỘ</b> </a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="qlPhongBan.php?cv=dsPhongBan"><b>PHÒNG BAN</b></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="qlChucVu.php?cv=dsChucVu"><b>CHỨC VỤ</b></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="qlBangLuong.php?cv=dsBangLuong"><b>BẢNG LƯƠNG</b></a>
			</li>
			<li class="nav-item">
	...
	<div id="uploadModal">
		...
		<form action="../users/upload.php" method="post" enctype="multipart/form-data">
			<input type="file" name="photo" onchange="enableSubmit()" accept="image/*">
			<button type="submit" id="submitBtn" disabled>Tải ảnh lên</button>
		</form>
